import{a as g,S as y,i}from"./assets/vendor-BLPZKqeQ.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const h="50447683-96da9a4ff1c3a2668348e0aa0",b="https://pixabay.com/api/";async function L(s){const r={key:h,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0};return console.log("Надсилаємо запит з параметрами:",r),(await g.get(b,{params:r})).data}const u=document.querySelector(".gallery"),f=document.getElementById("loader");let l;function w(s){const r=s.map(({webformatURL:o,largeImageURL:a,tags:e,likes:t,views:n,comments:m,downloads:p})=>`
